...
- Import `PdfPages(...)` from `oodocs.pdf` when existing PDF pages should be inserted into PDF output. DOCX and HTML render a link-style placeholder because editable page import is renderer-specific; see [docs/reference/table-media-support.md](docs/reference/table-media-support.md).
