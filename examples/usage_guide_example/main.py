...
def build_usage_guide_document() -> Document:
    ...
    latex_transition_table = Table(
        ...
        rows=[
            ...
            ["glossaries, acronym, or nomencl", "Glossary(), GlossaryList(glossary), or Nomenclature(...)", "Terms and acronyms live in a Python registry; symbol tables can still use the boxed Nomenclature preset."],
    ...
    block_options_table = Table(
        ...
        rows=[
            ...
            ["Glossary, GlossaryList", "term(...), acronym(...), use(...), sort", "Use Nomenclature for symbol/unit tables and GlossaryList for collected terms."],
