...
def build_usage_guide_document() -> Document:
    ...
    page_layout_table = Table(
        ...
        rows=[
            ...
            ["Switch one section", "Section(..., page_layout=PageLayout.landscape(...))", "DOCX and PDF start a new page layout section; HTML emits a page-break CSS fallback."],
    ...
    contents_style_table = Table(
        ...
        rows=[
            ...
            ["Appendix entries", "Shown as an unnumbered separator followed by A/B/C child chapters.", "Import Appendix from oodocs.structure when end matter needs appendix numbering and contents entries; validation warns if main chapters continue afterward."],
    ...
    theme_options_table = Table(
        ...
        rows=[
            ...
            ["HeaderFooterDefaults", "header/footer left, center, right; first/even page overrides", "Running heads, page tokens, and first/odd-even page styles."],
    ...
    block_options_table = Table(
        ...
        rows=[
            ...
            ["oodocs.glossary", "Glossary.term(...), acronym(...), use(...), and ListOfGlossaryTerms(sort=...)", "Use Nomenclature for symbol/unit tables and ListOfGlossaryTerms for collected terms."],
