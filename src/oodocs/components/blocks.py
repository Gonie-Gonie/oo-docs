...
class Equation(Block):
    ...
    def from_sympy(
        ...
        *,
        ...
        """Create an equation from a SymPy expression.

        Args:
            expression: SymPy expression accepted by ``sympy.latex``.
            numbered: Whether the block participates in equation numbering.
            reference_label: Label prefix used by automatic inline references.
            style: Base paragraph style.
            text_alignment: Optional text alignment override.
        ...
        Returns:
            Equation block containing the SymPy LaTeX representation.
        ...
        Examples:
            ...
            equation = Equation.from_sympy(sympy_expr)
            ```
        """
        ...
        try:
            ...
            raise ImportError(
                "Equation.from_sympy requires SymPy. Install it with `pip install sympy`."
            ) from exc

        return cls(
            str(sympy_module.latex(expression)),
            numbered=numbered,
            reference_label=reference_label,
            style=style,
            text_alignment=text_alignment,
